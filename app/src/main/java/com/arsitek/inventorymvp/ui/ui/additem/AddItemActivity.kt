...
import kotlinx.android.synthetic.main.activity_add_item.et_nama
import kotlinx.android.synthetic.main.activity_add_item.et_stock
import kotlinx.android.synthetic.main.activity_add_item.iv_barang
...
class AddItemActivity : AppCompatActivity(), AddItemView {
    ...
    var imgUri: Uri? = null
    val presenter = AddItemPresenter(this)
